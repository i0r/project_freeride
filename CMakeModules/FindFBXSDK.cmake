...
if (NOT DEFINED FBXSDK_SDKS)
   set(FBXSDK_SDKS "${DUSK_BASE_FOLDER}DuskEd/ThirdParty/FBX_SDK/")
endif()

get_filename_component(FBXSDK_SDKS_ABS ${FBXSDK_SDKS} ABSOLUTE)

set(FBXSDK_APPLE_ROOT   "${FBXSDK_SDKS_ABS}/Darwin/")
set(FBXSDK_LINUX_ROOT   "${FBXSDK_SDKS_ABS}/Linux/")
set(FBXSDK_WINDOWS_ROOT "${FBXSDK_SDKS_ABS}/Windows/")
...
elseif (WIN32)
  ...
  set(_libxml2_libname_debug "libxml2-md.lib")
  set(_libxml2_libname_release "libxml2-md.lib")
...
find_library(LIBXML2_LIBRARY ${_libxml2_libname_release}
  NO_CMAKE_FIND_ROOT_PATH
  PATHS "${FBXSDK_ROOT}/${_fbxsdk_libdir_debug}")
message("LIBXML2_LIBRARY: ${LIBXML2_LIBRARY}")

find_library(LIBXML2_LIBRARY_DEBUG ${_libxml2_libname_debug}
  NO_CMAKE_FIND_ROOT_PATH
  PATHS "${FBXSDK_ROOT}/${_fbxsdk_libdir_debug}")
message("LIBXML2_LIBRARY_DEBUG: ${LIBXML2_LIBRARY_DEBUG}")
