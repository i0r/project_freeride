...
// Rendering descriptors for high-level Renderer
// It has to be shared with the Core library since some
// subsystems requires Rendering specifics infos (e.g. ImageDescriptor)
// TODO Should be refactored in the future to avoid deps between libs
// 
