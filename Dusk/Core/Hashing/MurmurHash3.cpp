...
FORCE_INLINE u32 getblock32 ( const u32 * p, i32 i )
{
  return p[i];
}

FORCE_INLINE uint64_t getblock64 ( const uint64_t * p, i32 i )
{
  return p[i];
}
...
void MurmurHash3_x86_32 ( const void * key, i32 len,
                          u32 seed, void * out )
{
  const uint8_t * data = (const uint8_t*)key;
  const i32 nblocks = len / 4;
...
void MurmurHash3_x86_128 ( const void * key, const i32 len,
                           u32 seed, void * out )
{
  const uint8_t * data = (const uint8_t*)key;
...
void MurmurHash3_x64_128 ( const void * key, const i32 len,
